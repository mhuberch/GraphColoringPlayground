export default {
    ...
    GreedyWorkedOrder: "Greedy algorithm using with the following ordering of vertices:",
    IfDesiredActiveStepByStep: "If desired, active 'Step-by-Step Info' in the 'Options' and rerun the coloring algorithm.",
